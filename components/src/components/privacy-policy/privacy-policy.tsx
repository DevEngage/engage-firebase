...
export interface EngagePrivacyPartner {
  name?: string;
  details?: string;
  company?: string;
  optOut?: string;
...
@Component({
  tag: 'eng-privacy-policy'
})
export class EngagePrivacyPolicy {
  ...
  /* Custom Services*/
  @Prop() analytics: EngagePrivacyPartner[] = [];
  @Prop() advertising: EngagePrivacyPartner[] = [];
  @Prop() remarketing: EngagePrivacyPartner[] = [];
  @Prop() payments: EngagePrivacyPartner[] = [];
  @Prop() storage: EngagePrivacyPartner[] = [];
